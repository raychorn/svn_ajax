		...
		<cfsavecontent variable="_html">
			<cfoutput>
				<div id="div_objectCreatorMakeType" style="display: inline;">
					...
					<span class="boldPromptTextClass">Class Path:&nbsp;</span>
				...
				<div id="div_objectCreatorAvailableType" style="display: inline;">
					<span class="boldPromptTextClass">Available Type(s):&nbsp;</span>
				...
				<div id="div_objectCreatorWorkingWith" style="display: inline;">
					<span class="boldPromptTextClass">Working With Object:&nbsp;</span>
					...
					<table width="250" cellpadding="-1" cellspacing="-1">
						<tr>
							<td bgcolor="silver" align="center">
								<span class="boldPromptTextClass">Class Name:&nbsp;</span>
						...
						<tr>
							<td>
								<table width="100%" cellpadding="-1" cellspacing="-1">
									...
									<tr>
										<td align="center">
											<span class="boldPromptTextClass">Pub Version:</span>
										</td>
										<td align="left">
									...
									<tr>
										<td align="center">
											<span class="boldPromptTextClass">Edit Version:</span>
										</td>
										<td align="left">
									...
									<tr>
										<td align="center">
											<span class="boldPromptTextClass">Created/Updated By:</span>
										</td>
										<td align="left">
						...
						<tr>
							<td>
								...
								<table width="100%" cellpadding="-1" cellspacing="-1">
									<tr>
										<td align="center">
											<span class="boldPromptTextClass">Attribute Name:</span>
										</td>
										<td align="left">
									...
									<tr>
										<td align="center">
											<span class="boldPromptTextClass">Value:</span>
										</td>
										<td align="left">
				...
				<div id="div_objectCreatorListAttributes" style="display: inline;">
					<span class="boldPromptTextClass">Search for Attribute Name:&nbsp;</span>
