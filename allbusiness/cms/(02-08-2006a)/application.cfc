<cfcomponent>
	...
	<cffunction name="_onApplicationStart" access="private">
		<cftry>
			...
			<cfcatch type="database">
				<cflog file="#This.Name#" type="error" text="#GetToken(this.const_SQL_DSNs, this.count_SQL_DSNs, ",")# DSN is not available. message: #cfcatch.message# Detail: #cfcatch.detail# Native Error: #cfcatch.NativeErrorCode#" >
	...
	<cffunction name="_onRequestStart" access="private">
		...
		<cfset var lst_external_interfaces = "index_page.cfm,index_random_articles.cfm,index_chart_sample.cfm">
