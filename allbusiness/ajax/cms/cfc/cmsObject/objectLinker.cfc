							...
							<tr>
								...
								<td>
									<table width="100%" cellpadding="-1" cellspacing="-1">
										<tr>
											<td>
												<input disabled type="button" class="buttonClass" name="btn_removeObject2Link" id="btn_removeObject2Link" value="[<<]" onclick="var obj = objectLinker_getGUIObjectInstanceById('anObjectList'); if (obj != null) { var sels = objectLinker_getSelectionsFromObj(obj); removeObject2LinkUsing(sels); this.disabled = true; var obj2 = objectLinker_getGUIObjectInstanceById('btn_performObjectLinker'); if (obj2 != null) { var objMsg1 = objectLinker_getGUIObjectInstanceById('span_objectPickerObjectsLinker_errorMsg'); if (objMsg1 != null) { objMsg1.innerHTML = ''; }; var objMsg2 = objectLinker_getGUIObjectInstanceById('span_objectPickerObjectsLinker_statusMsg'); if (objMsg2 != null) { objMsg2.innerHTML = ''; }; obj2.disabled = true; } }; return false;">
											</td>
										</tr>
										<tr>
											<td>
								...
								<td>
									<table width="100%" cellpadding="-1" cellspacing="-1">
										<tr>
											...
											<td align="left">
												<input disabled type="text" name="linkEditorOwnerPropertyName" id="linkEditorOwnerPropertyName" class="textClass" size="50" maxlength="50">
											</td>
										</tr>
										<tr>
											<td align="center">
											...
											<td align="left">
												<input disabled type="text" name="linkEditorRelatedPropertyName" id="linkEditorRelatedPropertyName" class="textClass" size="50" maxlength="50">
											</td>
										</tr>
										<tr>
											<td align="center">
											...
											<td align="left">
												<input disabled type="text" name="linkEditorOwnerAutoload" id="linkEditorOwnerAutoload" class="textClass" size="10" maxlength="12">
											</td>
										</tr>
										<tr>
											<td align="center">
											...
											<td align="left">
												<input disabled type="text" name="linkEditorRelatedAutoload" id="linkEditorRelatedAutoload" class="textClass" size="10" maxlength="12">
											</td>
										</tr>
										<tr>
											<td align="center">
											...
											<td align="left">
												<input disabled type="text" name="linkEditorDisplayOrder" id="linkEditorDisplayOrder" class="textClass" size="10" maxlength="12">
											</td>
										</tr>
										<tr>
											<td align="center">
											...
											<td align="left">
												<input disabled type="text" name="linkEditorStartVersion" id="linkEditorStartVersion" class="textClass" size="10" maxlength="12">
											</td>
										</tr>
										<tr>
											<td align="center">
